...
bool rust_widgets_begin_drag(uint64_t source, const char* mime_type, const u8* payload, unsigned int payload_len);
...
bool rust_widgets_combo_box_set_current_index(uint64_t combo_box, unsigned int index);
...
uint64_t rust_widgets_create_color_dialog(uint64_t parent, const char* title, int x, int y, unsigned int width, unsigned int height);
uint64_t rust_widgets_create_combo_box(uint64_t parent, int x, int y, unsigned int width, unsigned int height);
uint64_t rust_widgets_create_file_dialog(uint64_t parent, const char* title, int x, int y, unsigned int width, unsigned int height);
uint64_t rust_widgets_create_font_dialog(uint64_t parent, const char* title, int x, int y, unsigned int width, unsigned int height);
...
uint64_t rust_widgets_create_list_view(uint64_t parent, int x, int y, unsigned int width, unsigned int height);
...
uint64_t rust_widgets_create_message_box(uint64_t parent, const char* title, const char* text, int x, int y, unsigned int width, unsigned int height);
...
uint64_t rust_widgets_create_scroll_area(uint64_t parent, int x, int y, unsigned int width, unsigned int height);
uint64_t rust_widgets_create_slider(uint64_t parent, int x, int y, unsigned int width, unsigned int height);
uint64_t rust_widgets_create_spin_box(uint64_t parent, int x, int y, unsigned int width, unsigned int height);
...
bool rust_widgets_get_widget_geometry(uint64_t widget_id, int* x_out, int* y_out, unsigned int* width_out, unsigned int* height_out);
...
bool rust_widgets_list_box_set_current_index(uint64_t list_box, unsigned int index);
...
bool rust_widgets_poll_drop_event(uint64_t* source_out, uint64_t* target_out, char** mime_out, *mut u8* payload_out, unsigned int* payload_len_out);
...
void rust_widgets_set_widget_geometry(uint64_t widget_id, int x, int y, unsigned int width, unsigned int height);
