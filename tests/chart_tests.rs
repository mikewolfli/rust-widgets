...
fn test_chart_series() {
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 1.0, label: None },
            DataPoint { x: 1.0, y: 2.0, label: None },
            DataPoint { x: 2.0, y: 3.0, label: None },
        ],
...
fn test_chart_series_data() {
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 20.5, label: None },
            DataPoint { x: 1.0, y: 22.3, label: None },
            DataPoint { x: 2.0, y: 25.1, label: None },
        ],
...
fn test_chart_clear_series() {
    ...
    let series1 = ChartSeries {
        name: "Series 1".to_string(),
        data: vec![DataPoint { x: 0.0, y: 1.0, label: None }],
        color: Color::rgba(0, 0, 255, 255),
        visible: true,
    };
    ...
    let series2 = ChartSeries {
        ...
        data: vec![DataPoint { x: 0.0, y: 2.0, label: None }],
        color: Color::rgba(255, 0, 0, 255),
        visible: true,
    };
...
fn test_bar_chart_draw() {
    ...
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 100.0, label: Some("Q1".to_string()) },
            DataPoint { x: 1.0, y: 150.0, label: Some("Q2".to_string()) },
            DataPoint { x: 2.0, y: 120.0, label: Some("Q3".to_string()) },
        ],
        color: Color::rgba(0, 128, 255, 255),
        visible: true,
    };
...
fn test_pie_chart_draw() {
    ...
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 40.0, label: Some("Product A".to_string()) },
            DataPoint { x: 1.0, y: 30.0, label: Some("Product B".to_string()) },
            DataPoint { x: 2.0, y: 30.0, label: Some("Product C".to_string()) },
        ],
        color: Color::rgba(0, 128, 255, 255),
        visible: true,
    };
...
fn test_scatter_chart_draw() {
    ...
    let series = ChartSeries {
        ...
        data: vec![
            ...
            DataPoint { x: 3.0, y: 3.0, label: None },
            DataPoint { x: 4.0, y: 5.0, label: None },
        ],
...
fn test_area_chart_draw() {
    ...
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 10.0, label: None },
            DataPoint { x: 1.0, y: 25.0, label: None },
            DataPoint { x: 2.0, y: 40.0, label: None },
            DataPoint { x: 3.0, y: 35.0, label: None },
        ],
...
fn test_multiple_series_chart() {
    ...
    let series2 = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 15.0, label: None },
            DataPoint { x: 1.0, y: 25.0, label: None },
        ],
        color: Color::rgba(0, 0, 255, 255),
        visible: true,
...
fn test_chart_with_hidden_series() {
    ...
    let visible_series = ChartSeries {
        ...
        data: vec![DataPoint { x: 0.0, y: 10.0, label: None }],
    ...
    let hidden_series = ChartSeries {
        ...
        data: vec![DataPoint { x: 0.0, y: 20.0, label: None }],
        color: Color::rgba(255, 0, 0, 255),
        visible: false,
    };
...
fn test_chart_series_with_labels() {
    let series = ChartSeries {
        ...
        data: vec![
            DataPoint { x: 0.0, y: 10.0, label: Some("Point A".to_string()) },
            DataPoint { x: 1.0, y: 20.0, label: Some("Point B".to_string()) },
            DataPoint { x: 2.0, y: 15.0, label: Some("Point C".to_string()) },
        ],
        color: Color::rgba(0, 128, 255, 255),
        visible: true,
    };
