...
fn creation_cases(backend: &CustomPaintControlBackend, parent: ObjectId) -> Vec<CreationCase> {
    vec![
        ...
        ("create_activity_indicator", backend.create_activity_indicator(parent, 0, 0, W, H), "progress_bar"),
        ("create_adaptive_scaffold", backend.create_adaptive_scaffold(parent, 0, 0, W, H), "adaptive_scaffold"),
        ("create_animated_image", backend.create_animated_image(parent, 0, 0, W, H), "animated_image"),
        ("create_app_bar", backend.create_app_bar(parent, 0, 0, W, H), "app_bar"),
        ("create_arc", backend.create_arc(parent, 0, 0, W, H), "arc"),
        ("create_audio_visualizer", backend.create_audio_visualizer(parent, 0, 0, W, H), "audio_visualizer"),
        ("create_auto_complete_edit", backend.create_auto_complete_edit(parent, 0, 0, W, H), "auto_complete_edit"),
        ...
        ("create_barcode_scanner", backend.create_barcode_scanner(parent, 0, 0, W, H), "barcode_scanner"),
        ("create_bezier_curve_editor", backend.create_bezier_curve_editor(parent, 0, 0, W, H), "bezier_curve_editor"),
        ("create_bottom_navigation_bar", backend.create_bottom_navigation_bar(parent, 0, 0, W, H), "bottom_navigation_bar"),
        ...
        ("create_camera_preview", backend.create_camera_preview(parent, 0, 0, W, H), "camera_preview"),
        ("create_candlestick_chart", backend.create_candlestick_chart(parent, 0, 0, W, H), "candlestick_chart"),
        ...
        ("create_collapsible_pane", backend.create_collapsible_pane(parent, "t", 0, 0, W, H), "collapsible_pane"),
        ("create_color_dialog", backend.create_color_dialog(parent, "t", 0, 0, W, H), "color_dialog"),
        ...
        ("create_command_link", backend.create_command_link(parent, "t", 0, 0, W, H), "command_link"),
        ("create_context_menu", backend.create_context_menu(parent, "t", 0, 0, W, H), "menu"),
        ("create_cupertino_alert_dialog", backend.create_cupertino_alert_dialog(parent, 0, 0, W, H), "cupertino_alert_dialog"),
        ("create_cupertino_date_picker", backend.create_cupertino_date_picker(parent, 0, 0, W, H), "cupertino_date_picker"),
        ("create_cupertino_navigation_bar", backend.create_cupertino_navigation_bar(parent, 0, 0, W, H), "cupertino_navigation_bar"),
        ("create_cupertino_segmented_control", backend.create_cupertino_segmented_control(parent, 0, 0, W, H), "cupertino_segmented_control"),
        ("create_cupertino_slider", backend.create_cupertino_slider(parent, 0, 0, W, H), "cupertino_slider"),
        ("create_cupertino_switch", backend.create_cupertino_switch(parent, 0, 0, W, H), "cupertino_switch"),
        ...
        ("create_date_range_picker", backend.create_date_range_picker(parent, 0, 0, W, H), "date_range_picker"),
        ("create_date_time_picker", backend.create_date_time_picker(parent, 0, 0, W, H), "date_time_edit"),
        ...
        ("create_directory_dialog", backend.create_directory_dialog(parent, "t", 0, 0, W, H), "file_dialog"),
        ...
        ("create_editable_combo_box", backend.create_editable_combo_box(parent, 0, 0, W, H), "editable_combo_box"),
        ...
        ("create_find_replace_dialog", backend.create_find_replace_dialog(parent, 0, 0, W, H), "find_replace_dialog"),
        ("create_floating_label", backend.create_floating_label(parent, 0, 0, W, H), "floating_label"),
        ("create_font_combo_box", backend.create_font_combo_box(parent, 0, 0, W, H), "font_combo_box"),
        ...
        ("create_freeform_shape", backend.create_freeform_shape(parent, 0, 0, W, H), "freeform_shape"),
        ...
        ("create_hero_animation", backend.create_hero_animation(parent, 0, 0, W, H), "hero_animation"),
        ...
        ("create_indicator_chart", backend.create_indicator_chart(parent, 0, 0, W, H), "indicator_chart"),
        ("create_inplace_editor", backend.create_inplace_editor(parent, 0, 0, W, H), "inplace_editor"),
        ...
        ("create_masonry_layout", backend.create_masonry_layout(parent, 0, 0, W, H), "masonry_layout"),
        ("create_material_navigation_rail", backend.create_material_navigation_rail(parent, 0, 0, W, H), "material_navigation_rail"),
        ("create_material_snackbar", backend.create_material_snackbar(parent, 0, 0, W, H), "material_snackbar"),
        ...
        ("create_message_box", backend.create_message_box(parent, "t", "t", 0, 0, W, H), "message_box"),
        ...
        ("create_mobile_date_picker", backend.create_mobile_date_picker(parent, 0, 0, W, H), "mobile_date_picker"),
        ("create_modal_bottom_sheet", backend.create_modal_bottom_sheet(parent, 0, 0, W, H), "modal_bottom_sheet"),
        ("create_multi_select_combo_box", backend.create_multi_select_combo_box(parent, 0, 0, W, H), "multi_select_combo_box"),
        ("create_navigation_drawer", backend.create_navigation_drawer(parent, 0, 0, W, H), "navigation_drawer"),
        ("create_navigation_stack", backend.create_navigation_stack(parent, 0, 0, W, H), "navigation_stack"),
        ...
        ("create_popup_window", backend.create_popup_window(parent, "t", 0, 0, W, H), "popup_window"),
        ("create_progress_bar", backend.create_progress_bar(parent, 0, 0, W, H), "progress_bar"),
        ("create_progress_circle", backend.create_progress_circle(parent, 0, 0, W, H), "progress_circle"),
        ("create_properties_panel", backend.create_properties_panel(parent, 0, 0, W, H), "properties_panel"),
        ...
        ("create_radio_button", backend.create_radio_button(parent, "t", 0, 0, W, H), "radio_button"),
        ...
        ("create_refresh_control", backend.create_refresh_control(parent, 0, 0, W, H), "refresh_control"),
        ...
        ("create_segmented_button", backend.create_segmented_button(parent, 0, 0, W, H), "segmented_button"),
        ("create_shortcut_editor", backend.create_shortcut_editor(parent, 0, 0, W, H), "shortcut_editor"),
        ("create_skeleton_loader", backend.create_skeleton_loader(parent, 0, 0, W, H), "skeleton_loader"),
        ...
        ("create_swipe_to_dismiss", backend.create_swipe_to_dismiss(parent, 0, 0, W, H), "swipe_to_dismiss"),
        ...
        ("create_toggle_button", backend.create_toggle_button(parent, "t", 0, 0, W, H), "toggle_button"),
        ...
        ("create_web_engine_context_menu_request", backend.create_web_engine_context_menu_request(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_cookie_store", backend.create_web_engine_cookie_store(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_download_item", backend.create_web_engine_download_item(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_find_text_result", backend.create_web_engine_find_text_result(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_notification", backend.create_web_engine_notification(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_page", backend.create_web_engine_page(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_script_dialog", backend.create_web_engine_script_dialog(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_settings", backend.create_web_engine_settings(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_view", backend.create_web_engine_view(parent, 0, 0, W, H), "web_engine_view"),
        ("create_web_engine_web_channel", backend.create_web_engine_web_channel(parent, 0, 0, W, H), "web_engine_view"),
