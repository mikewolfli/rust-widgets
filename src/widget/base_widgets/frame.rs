...
impl Frame {
    ...
    fn frame_padding(&self) -> Padding {
        match self.frame_shape {
            FrameShape::NoFrame => Padding::all(0.0),
            FrameShape::Box
            | FrameShape::Panel
            ...
            | FrameShape::WinPanel => {
                ...
                match self.frame_shadow {
                    ...
                    FrameShadow::Raised | FrameShadow::Sunken => Padding::all(total_width * 2.0),
                }
            }
            FrameShape::HLine => {
                let line_width = self.line_width;
                Padding::new(0.0, line_width, 0.0, line_width)
            }
            FrameShape::VLine => {
                let line_width = self.line_width;
                Padding::new(line_width, 0.0, line_width, 0.0)
            }
        }
    }
    ...
    fn draw_frame(&self, context: &mut RenderContext) {
        ...
        match self.frame_shape {
            ...
            FrameShape::Panel => {
                self.draw_panel_frame(context, rect);
            }
            FrameShape::StyledPanel => {
                self.draw_styled_panel_frame(context, rect);
            }
            FrameShape::HLine => {
                self.draw_hline_frame(context, rect);
            }
            FrameShape::VLine => {
                self.draw_vline_frame(context, rect);
            }
            FrameShape::WinPanel => {
                self.draw_win_panel_frame(context, rect);
            }
        }
    }
    ...
    fn draw_box_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        match self.frame_shadow {
            ...
            FrameShadow::Raised => {
                ...
                // Top and left (light)
                context.draw_line(rect.x, rect.y, rect.x + rect.width, rect.y, light_color);
                context.draw_line(rect.x, rect.y, rect.x, rect.y + rect.height, light_color);
    ...
    fn draw_styled_panel_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        context.fill_rect(rect.x, rect.y, rect.width, rect.height, bg_color);
        self.draw_box_frame(context, rect);
    }
    ...
    fn draw_hline_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        context.draw_line(rect.x, y, rect.x + rect.width, y, Color::from_rgb(0, 0, 0));
    }
    ...
    fn draw_vline_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        context.draw_line(x, rect.y, x, rect.y + rect.height, Color::from_rgb(0, 0, 0));
    }
    ...
    fn draw_win_panel_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        // Outer border (sunken)
        context.draw_line(rect.x, rect.y, rect.x + rect.width, rect.y, dark_color);
        context.draw_line(rect.x, rect.y, rect.x, rect.y + rect.height, dark_color);
        context.draw_line(
            rect.x,
            rect.y + rect.height,
            rect.x + rect.width,
