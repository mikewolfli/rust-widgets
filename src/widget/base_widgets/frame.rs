...
impl Frame {
    ...
    fn draw_box_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        match self.frame_shadow {
            ...
            FrameShadow::Raised => {
                ...
                // Top and left (light)
                context.draw_line(Point::new(Point::new(rect.x, rect.y)), Point::new(Point::new(rect.x + rect.width as i32 as i32, rect.y)), light_color,);
                context.draw_line(Point::new(Point::new(rect.x, rect.y)), Point::new(Point::new(rect.x, rect.y + rect.height as i32 as i32)), light_color,);
                // Bottom and right (dark)
                context.draw_line(Point::new(Point::new(rect.x, rect.y + rect.height as i32 as i32)), Point::new(Point::new(
                        rect.x + rect.width as i32 as i32, rect.y + rect.height as i32 as i32), ),
                    dark_color,
                );
                context.draw_line(Point::new(Point::new(rect.x + rect.width as i32 as i32, rect.y)), Point::new(rect.x + rect.width as i32 as i32, rect.y + rect.height as i32 as i32), dark_color,);
                // Draw mid line if needed
                if mid_line_width > 0 {
                    let mid_light = Color::from_rgb(192, 192, 192);
                    let mid_dark = Color::from_rgb(64, 64, 64);
                    context.draw_line(Point::new(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + line_width as i32 as i32 as i32)), Point::new(Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + line_width as i32 as i32 as i32)), mid_light,);
                    context.draw_line(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + line_width as i32 as i32 as i32), Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + rect.height as i32 - line_width as i32), mid_light,);
                    context.draw_line(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + rect.height as i32 - line_width), Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + rect.height as i32 - line_width as i32), mid_dark,);
                    context.draw_line(Point::new(rect.x + rect.width as i32 - line_width, rect.y + line_width as i32 as i32 as i32), Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + rect.height as i32 - line_width as i32), mid_dark,);
                }
            }
            FrameShadow::Sunken => {
                // Draw sunken border
                ...
                context.draw_line(Point::new(rect.x, rect.y + rect.height as i32), Point::new(rect.x + rect.width as i32, rect.y + rect.height as i32), dark_color,);
                context.draw_line(Point::new(rect.x + rect.width as i32, rect.y), Point::new(rect.x + rect.width as i32, rect.y + rect.height as i32), dark_color,);
                // Draw mid line if needed
                if mid_line_width > 0 {
                    let mid_light = Color::from_rgb(64, 64, 64);
                    let mid_dark = Color::from_rgb(192, 192, 192);
                    context.draw_line(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + line_width as i32 as i32 as i32), Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + line_width as i32 as i32 as i32), mid_light,);
                    context.draw_line(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + line_width as i32 as i32 as i32), Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + rect.height as i32 - line_width as i32), mid_light,);
                    context.draw_line(Point::new(rect.x + line_width as i32 as i32 as i32, rect.y + rect.height as i32 - line_width), Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + rect.height as i32 - line_width as i32), mid_dark,);
                    context.draw_line(Point::new(rect.x + rect.width as i32 - line_width, rect.y + line_width as i32 as i32 as i32), Point::new(rect.x + rect.width as i32 - line_width as i32, rect.y + rect.height as i32 - line_width as i32), mid_dark,);
                }
    ...
    fn draw_hline_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        context.draw_line(Point::new(Point::new(rect.x, y)), Point::new(Point::new(rect.x + rect.width as i32 as i32, y)), Color::from_rgb(0, 0, 0),
        );
    }
    ...
    fn draw_vline_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        context.draw_line(Point::new(Point::new(x, rect.y)), Point::new(Point::new(x, rect.y + rect.height as i32 as i32)), Color::from_rgb(0, 0, 0),
        );
    }
    ...
    fn draw_win_panel_frame(&self, context: &mut RenderContext, rect: Rect) {
        ...
        let dark_color = Color::from_rgb(128, 128, 128);
        // Outer border (sunken)
        context.draw_line(Point::new(Point::new(rect.x, rect.y)), Point::new(Point::new(rect.x + rect.width as i32 as i32, rect.y)), dark_color,);
        context.draw_line(Point::new(Point::new(rect.x, rect.y)), Point::new(Point::new(rect.x, rect.y + rect.height as i32 as i32)), dark_color,);
        context.draw_line(Point::new(Point::new(rect.x, rect.y + rect.height as i32 as i32)), Point::new(Point::new(
                rect.x + rect.width as i32 as i32, rect.y + rect.height as i32 as i32), ),
            light_color,
        );
        context.draw_line(Point::new(Point::new(rect.x + rect.width as i32 as i32, rect.y)), Point::new(Point::new(
                rect.x + rect.width as i32 as i32, rect.y + rect.height as i32 as i32), ),
            light_color,
        );
        // Inner border (raised)
        ...
        context.draw_line(Point::new(inner_rect.x, inner_rect.y), Point::new(inner_rect.x + inner_rect.width, inner_rect.y), light_color,);
        context.draw_line(Point::new(inner_rect.x, inner_rect.y), Point::new(inner_rect.x, inner_rect.y + inner_rect.height), light_color,);
        context.draw_line(Point::new(inner_rect.x, inner_rect.y + inner_rect.height), Point::new(inner_rect.x + inner_rect.width, inner_rect.y + inner_rect.height), dark_color,);
        context.draw_line(Point::new(inner_rect.x + inner_rect.width, inner_rect.y), Point::new(inner_rect.x + inner_rect.width, inner_rect.y + inner_rect.height), dark_color,);
    }
}
