...
impl Action {
    ...
    pub fn icon_text(&self) -> &str { &self.icon_text }
    pub fn shortcut(&self) -> &str { &self.shortcut }
    pub fn is_checkable(&self) -> bool { self.checkable }
    pub fn is_checked(&self) -> bool { self.checked }
    pub fn is_separator(&self) -> bool { self.separator }
    ...
    pub fn set_checkable(&mut self, checkable: bool) {
        ...
        if !checkable { self.checked = false; }
        self.changed.emit();
    }
