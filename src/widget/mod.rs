...
/// Directory dialog widget for selecting directories.
...
impl DirectoryDialog {
    pub fn new(geometry: Rect) -> Self {
        Self {
            base: BaseWidget::new(WidgetKind::DirectoryDialog, geometry, "DirectoryDialog"),
...
impl Widget for DirectoryDialog {
    fn id(&self) -> ObjectId {
        self.base.id()
    }
    fn kind(&self) -> WidgetKind {
...
impl EventHandler for DirectoryDialog {
    fn handle_event(&mut self, event: &Event) {
        self.base.handle_event(event);
    }
}
