...
//!
//! # Not a toolkit's `Stepper` (BLUE22 · F-8)
//!
...
//!
//! | this crate | the shared table | what it is |
//! |---|---|---|
...
//! collision with the shared table's vocabulary for one with this crate's own history; naming both here
