...
impl CheckBoxRenderer {
    ...
    fn draw_high_quality(
        ...
        context.fill_rect(shadow_rect, Color::from_rgba(0, 0, 0, 30));
    ...
    fn draw_low_quality(context: &mut RenderContext, rect: Rect, state: CheckState, enabled: bool) {
        ...
        if enabled {
            context.draw_rect(checkbox_rect, Color::from_rgb(100, 100, 100), 1);
        }
    ...
    fn draw_simple_checkmark(context: &mut RenderContext, rect: Rect, color: Color) {
        ...
        context.draw_line(rect.x + 4, rect.y + 8, rect.x + 7, rect.y + 11, color, 2);
        context.draw_line(rect.x + 7, rect.y + 11, rect.x + 12, rect.y + 6, color, 2);
    }
    ...
    fn draw_simple_partial_check(context: &mut RenderContext, rect: Rect, color: Color) {
        let y = rect.y + rect.height as i32 / 2;
        context.draw_line(rect.x + 4, y, rect.right() - 4, y, color, 2);
    }
