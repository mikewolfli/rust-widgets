...
use crate::render::{RenderCommand, SceneLayer, push_widget_fill_and_border};
use crate::widget::{Widget, web_view::WebView};

/// Append visual commands for a `WebView` baseline representation.
pub fn append_web_view_visual_commands(
