...
unsigned int rw_widget_list_item(uint64_t widget_id, unsigned int index, char* out, unsigned int cap);
unsigned int rw_widget_property_names(uint64_t widget_id, char* out, unsigned int cap);
unsigned int rw_widget_property_tokens(uint64_t widget_id, const char* name, char* out, unsigned int cap);
