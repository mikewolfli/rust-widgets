...
# ------------------------------------------------------------------ #
# EW aliases for compatibility                                        #
# ------------------------------------------------------------------ #
EW_ERROR_SUCCESS = RW_ERROR_SUCCESS
EW_ERROR_NOT_IMPLEMENTED = RW_ERROR_NOT_IMPLEMENTED
EW_ERROR_UNSUPPORTED_OPERATION = RW_ERROR_UNSUPPORTED_OPERATION
EW_ERROR_INVALID_ARGUMENT = RW_ERROR_INVALID_ARGUMENT
EW_ERROR_NULL_POINTER = RW_ERROR_NULL_POINTER
EW_ERROR_OUT_OF_MEMORY = RW_ERROR_OUT_OF_MEMORY
EW_ERROR_LOCK_POISONED = RW_ERROR_LOCK_POISONED
EW_ERROR_GENERAL = RW_ERROR_GENERAL
EW_ERROR_WIDGET_BASE_NOT_IMPL = RW_ERROR_WIDGET_BASE_NOT_IMPL
EW_ERROR_WIDGET_NOT_FOUND = RW_ERROR_WIDGET_NOT_FOUND
EW_ERROR_WIDGET_INVALID_STATE = RW_ERROR_WIDGET_INVALID_STATE
EW_ERROR_WIDGET_DEPRECATED = RW_ERROR_WIDGET_DEPRECATED
EW_ERROR_PLATFORM_UNSUPPORTED = RW_ERROR_PLATFORM_UNSUPPORTED
EW_ERROR_PLATFORM_INIT_FAILED = RW_ERROR_PLATFORM_INIT_FAILED
EW_ERROR_CLIPBOARD_FAILED = RW_ERROR_CLIPBOARD_FAILED
EW_ERROR_DRAG_DROP_FAILED = RW_ERROR_DRAG_DROP_FAILED
EW_ERROR_RENDER_CONTEXT_INVALID = RW_ERROR_RENDER_CONTEXT_INVALID
EW_ERROR_RENDER_PIPELINE_FAILED = RW_ERROR_RENDER_PIPELINE_FAILED
EW_ERROR_I18N_LOAD_FAILED = RW_ERROR_I18N_LOAD_FAILED
EW_ERROR_FILE_NOT_FOUND = RW_ERROR_FILE_NOT_FOUND
...
ERROR_NAMES: dict[int, str] = {
    ...
    RW_ERROR_GENERAL: "general error (panic or unexpected failure)",
