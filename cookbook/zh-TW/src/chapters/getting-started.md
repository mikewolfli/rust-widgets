...
[dependencies]
rust_widgets = { version = "1.1.2", features = ["desktop", "linux-wayland"] }

# 平板搭配自動偵測作業系統：
[dependencies]
rust_widgets = { version = "1.1.2", default-features = false, features = ["tablet"] }

# 最小內嵌（無 std）：
[dependencies]
rust_widgets = { version = "1.1.2", default-features = false, features = ["embedded"] }

# 行動 Android：
[dependencies]
rust_widgets = { version = "1.1.2", default-features = false, features = ["mobile", "android"] }

# WASM 網頁應用程式：
[dependencies]
rust_widgets = { version = "1.1.2", default-features = false, features = ["mobile", "wasm", "touch"] }
```
