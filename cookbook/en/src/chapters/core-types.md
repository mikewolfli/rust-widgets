...
// Desktop: Full profile, Desktop platform, desktop capabilities, v2.4.1
let desktop_config = CoreConfig::desktop();

// Embedded: Embedded profile, Embedded platform, embedded capabilities, v2.4.1
let embedded_config = CoreConfig::embedded();

// Mobile: Full profile, Mobile platform, mobile capabilities, v2.4.1
