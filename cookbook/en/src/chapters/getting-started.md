...
[dependencies]
rust_widgets = { version = "1.1.0", features = ["desktop", "linux-wayland"] }

# Tablet with auto-detected OS:
[dependencies]
rust_widgets = { version = "1.1.0", default-features = false, features = ["tablet"] }

# Minimal embedded (no std):
[dependencies]
rust_widgets = { version = "1.1.0", default-features = false, features = ["embedded"] }

# Mobile Android:
[dependencies]
rust_widgets = { version = "1.1.0", default-features = false, features = ["mobile", "android"] }

# WASM web app:
[dependencies]
rust_widgets = { version = "1.1.0", default-features = false, features = ["mobile", "wasm", "touch"] }
```
