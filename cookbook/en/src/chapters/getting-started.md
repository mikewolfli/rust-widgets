...
[dependencies]
rust_widgets = { version = "2.6.0", features = ["desktop", "linux-wayland"] }
...
# Mobile Android:
[dependencies]
rust_widgets = { version = "2.6.0", default-features = false, features = ["mobile", "android"] }

# WASM web app:
[dependencies]
rust_widgets = { version = "2.6.0", default-features = false, features = ["mobile", "wasm", "touch"] }
```
