...
[dependencies]
rust_widgets = { version = "2.5.2", features = ["desktop", "linux-wayland"] }

# Tablet with auto-detected OS:
[dependencies]
rust_widgets = { version = "2.5.2", default-features = false, features = ["tablet"] }
...
# Mobile Android:
[dependencies]
rust_widgets = { version = "2.5.2", default-features = false, features = ["mobile", "android"] }

# WASM web app:
[dependencies]
rust_widgets = { version = "2.5.2", default-features = false, features = ["mobile", "wasm", "touch"] }
```
