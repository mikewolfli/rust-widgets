...
|---|---|---|
| **Desktop** | `desktop` (default) | Full OS integration, GPU, touch, i18n, charts, print, PDF, a11y |
...
[dependencies]
rust_widgets = { version = "2.5.0", features = ["desktop", "linux-wayland"] }

# Tablet with auto-detected OS:
[dependencies]
rust_widgets = { version = "2.5.0", default-features = false, features = ["tablet"] }

# Minimal embedded (no std):
[dependencies]
rust_widgets = { version = "2.5.0", default-features = false, features = ["embedded"] }

# Mobile Android:
[dependencies]
rust_widgets = { version = "2.5.0", default-features = false, features = ["mobile", "android"] }

# WASM web app:
[dependencies]
rust_widgets = { version = "2.5.0", default-features = false, features = ["mobile", "wasm", "touch"] }
```
