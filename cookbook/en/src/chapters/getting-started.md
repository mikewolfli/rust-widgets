...
[dependencies]
rust_widgets = { version = "2.0.1", features = ["desktop", "linux-wayland"] }

# Tablet with auto-detected OS:
[dependencies]
rust_widgets = { version = "2.0.1", default-features = false, features = ["tablet"] }

# Minimal embedded (no std):
[dependencies]
rust_widgets = { version = "2.0.1", default-features = false, features = ["embedded"] }

# Mobile Android:
[dependencies]
rust_widgets = { version = "2.0.1", default-features = false, features = ["mobile", "android"] }

# WASM web app:
[dependencies]
rust_widgets = { version = "2.0.1", default-features = false, features = ["mobile", "wasm", "touch"] }
```
