...
// 桌面：Full profile, Desktop platform, desktop capabilities, v2.4.6
let desktop_config = CoreConfig::desktop();

// 嵌入式：Embedded profile, Embedded platform, embedded capabilities, v2.4.6
let embedded_config = CoreConfig::embedded();

// 移动端：Full profile, Mobile platform, mobile capabilities, v2.4.6
